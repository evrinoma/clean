 ...
 */
final class Version20210415111913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu_items ADD routeParameters  LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', ADD tag VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu_items DROP routeParameters , DROP tag');
    }
}
